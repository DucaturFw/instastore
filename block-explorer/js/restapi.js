...
exports.app.get("/txs", function (req, res) {
    var addr = "3MQTRzttkMtsMEy9dRq4Sf1xiSsWKgQkyH";
...
function getTransactions(addr, callback) {
    ...
    agent.get("" + url + addr, function (err, res) {
        ...
        var txs = obj.txs.map(function (tx) { return ({ tx: tx.out.filter(function (o) { return o.addr == addr; }), info: Object.assign({}, tx, { inputs: undefined, out: undefined }) }); });
